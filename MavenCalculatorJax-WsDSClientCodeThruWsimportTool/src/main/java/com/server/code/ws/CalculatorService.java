 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.code.server.com/", wsdlLocation = "http://localhost:7171/calculator/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7171/calculator/CalculatorWS?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ws.code.server.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.code.server.com/", "CalculatorPort"), Calculator.class, features);
    }
