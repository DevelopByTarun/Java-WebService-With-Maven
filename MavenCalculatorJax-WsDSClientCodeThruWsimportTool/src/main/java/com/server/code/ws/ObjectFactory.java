 ...
 * generated in the com.server.code.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://ws.code.server.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://ws.code.server.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ws.code.server.com/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://ws.code.server.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://ws.code.server.com/", "subtractResponse");
    private final static QName _Divide_QNAME = new QName("http://ws.code.server.com/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://ws.code.server.com/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://ws.code.server.com/", "multiply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.server.code.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.server.com/", name = "multiply")
