	...
	public static void main( String[] args ) {
    	...
    	while(true) {
    		...
    		if(choice == 1) {
    			...
    			int addResult = calcService.getCalculatorPort().add(num1, num2);
    			...
    			int subResult = calcService.getCalculatorPort().subtract(num1, num2);
    			...
    			int mulResult = calcService.getCalculatorPort().multiply(num1, num2);
    			...
    			int divResult = calcService.getCalculatorPort().divide(num1, num2);
