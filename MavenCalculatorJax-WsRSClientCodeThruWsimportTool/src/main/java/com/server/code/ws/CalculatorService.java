 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.code.server.com/", wsdlLocation = "http://localhost:9090/calculator/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.code.server.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/calculator/CalculatorWS?wsdl");
    ...
    public CalculatorWS getCalculatorPort() {
        return super.getPort(new QName("http://ws.code.server.com/", "CalculatorPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.code.server.com/", "CalculatorPort"), CalculatorWS.class, features);
    }
